"""GRU + Dueling: treat flat stacked obs as a sequence."""
...
class GRUDuelingDQN(nn.Module):
    """
    Input (B, state_dim) with state_dim = stack_k * raw_dim.
    Reshape to (B, stack_k, raw_dim), run GRU, then Dueling heads.
    """
