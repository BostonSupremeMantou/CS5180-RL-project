"""Prioritized replay: SumTree + importance-sampling weights."""
...
class SumTree:
    """Segment tree storing priorities; one leaf per ring-buffer slot."""
    ...
    def retrieve(self, s: float) -> int:
        """Return data index in [0, capacity-1]."""
        idx = 0
...
class PrioritizedReplayBuffer:
    """Ring buffer + SumTree; sample() returns IS weights."""
