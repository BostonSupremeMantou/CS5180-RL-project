...
def main() -> None:
    ...
    _draw_metric(
        ...
        "return_std",
        "Mean Return",
        "Evaluation Comparison: Return (higher is better)",
    ...
    _draw_metric(
        ...
        "iou_std",
        "Mean IoU Ref",
        "Evaluation Comparison: IoU (higher is better)",
    ...
    _draw_metric(
        ...
        "cons_std",
        "Mean Consistency",
        "Evaluation Comparison: Consistency (higher is better)",
    ...
    _draw_metric(
        ...
        "cost_std",
        "Mean Cost",
        "Evaluation Comparison: Cost (lower is better)",
